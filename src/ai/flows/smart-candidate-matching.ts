...
const SmartCandidateMatchingInputSchema = z.object({
  candidateResume: z
    .string()
    .describe('The candidate resume text.'),
...
You will use the candidate's resume and the job description to assess the fit and generate relevant interview questions.
